        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Formato estruturado ideal para APIs</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Formato tabular para Excel e planilhas</p>
            </div>
          </button>
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Formato estruturado para integrações</p>
            </div>
          </button>
        </div>

        {isExporting && <p className="text-center text-sm text-gray-500">Gerando arquivo...</p>}
      </div>
    </Modal>
  )
}
