...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-8izv5ge5=tx1(%ztn_=v4bq5jx!80hchiwj60c%-t7s&tm^$l%'
)
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10),  # Token de acesso expira em 10 minutos
    ...
    'UPDATE_LAST_LOGIN': True,  # Atualiza last_login ao fazer login
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Extrator de Planilhas API',
    'DESCRIPTION': 'API para upload, processamento e exportação de planilhas Excel',
    'VERSION': '1.0.0',
